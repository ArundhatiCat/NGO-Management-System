...
public class AdminReceiveItem extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(searchtitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, -1, -1));
        ...
        panel_1.setBackground(new java.awt.Color(255, 204, 204));
        ...
        add(panel_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(236, 239, -1, -1));

        add(manager_cmb, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 649, 118, -1));

        manager_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        manager_lbl.setText("Manager:");
        add(manager_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(263, 653, -1, -1));

        add(re_cmb, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 689, 118, -1));

        recepient_lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        recepient_lbl.setText("Recepient:");
        add(recepient_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 690, -1, -1));
